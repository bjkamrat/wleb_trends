...
gen_dat_2$start_year <- 2015 # Scenario 1: 2009-2015
...
write.csv(seasonal_results, file = paste("data/wrtds_output/trends/seasonal/",poi,"/scen3.csv",sep =""), row.names = FALSE)
